...
/**
  ...
  * See the [[https://www.elastic.co/guide/en/elasticsearch/reference/current/cat-indices.html Elasticsearch Docs]] for more info.
  */
trait IndexInfo {
  def health: String
  def status: String
...
/**
  ...
  * See the [[https://www.elastic.co/guide/en/elasticsearch/reference/1.7/cat-indices.html Elasticsearch Docs]] for more info.
  * @version 1.7
